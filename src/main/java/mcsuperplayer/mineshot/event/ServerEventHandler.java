...
public class ServerEventHandler {
	private static final List<DelayedAction> actions = new ArrayList<DelayedAction>(0);
	private static final List<DelayedAction> newactions = new ArrayList<DelayedAction>(0);
	...
	public static void onServerTick(TickEvent.ServerTickEvent event) {
		if (event.phase == TickEvent.Phase.END) {
			...
			newactions.removeAll(newactions);
		}
	}
