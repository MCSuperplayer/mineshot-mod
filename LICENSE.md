...
My mods are licensed under terms based on the license of [*FancyMenu*](https://github.com/Keksuccino/FancyMenu/blob/master/LICENSE.md), with specific modifications and naming tailored to my mods.
...
6. **Permission Requests**
   ...
   - **6.2.** To request such permission, please contact the author via Discord. Join the Discord server at https://discord.gg/Dv7cmCGSyT and send a private message to @mcsuperplayer detailing your intended use.
